...
class AnimeRepositoryTest {    //Validando o banco de dados.
    ...
    void findByName_ReturnsEmptyListOfAnime_WhenNoAnimeIsFound(){
        List<Anime> animes = this.animeRepository.findByName("Saseroro");
